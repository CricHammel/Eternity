...
public class SpawnOutriderCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (args.length != 0) {
			p.sendMessage(Main.defaultMessages.get("wrongArgs") + "/spawnoutrider");
			return false;
		}

		Outrider.getInstance().spawn(p.getLocation());
